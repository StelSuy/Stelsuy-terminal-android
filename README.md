...
**Stelsuy Terminal** — Android-додаток, що виконує роль стаціонарного NFC-терміналу для реєстрації відвідуваності. Встановлюється на вхід в офіс і зчитує дані з телефонів співробітників, які використовують  [stelsuy-employee-hce](https://github.com/StelSuy/Stelsuy-employee-hce) .
